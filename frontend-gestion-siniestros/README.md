# Frontend - Interfaz de Siniestros (Traductor de Endosos)

Interfaz de usuario orientada a la gestión, registro, consulta y seguimiento de siniestros de seguros, conectada al microservicio correspondiente de la arquitectura de microservicios.
...
> La interfaz web quedará accesible en el puerto configurado (por ejemplo, http://localhost:3200).
